(function() {
  ...
  map.on('load', function() {
    $.getJSON('https://raw.githubusercontent.com/schlos/chattanooga-bike-parking-locator/master/zagreb/bicycle-parking-locations-in-the-city-of-zagreb.json', function(data) {
      var points = [{
